namespace CsIRC.Core.Events
{
    ...
    /// </summary>
    public class UserReasonCommandEventArgs : IRCMessageEventArgs, IUserEvent
    {
        /// <summary>
        ...
        public UserReasonCommandEventArgs(IRCMessage message, IRCUser user, string reason) : base(message)
        {
            User = user;
            Reason = reason;
        }
